//
//  AVURLAssetTrackResource.swift
//  VFCabbage
//
//  Created by Joey Patino on 11/17/22.
//  Copyright © 2022 Joey Patino. All rights reserved.
//

import AVFoundation
import UIKit

public class AVURLAssetTrackResource: Resource {
    ...
    override public func copy(with zone: NSZone? = nil) -> Any {
        let resource = super.copy(with: zone) as! AVURLAssetTrackResource
